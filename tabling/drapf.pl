...
%% This is the shell for SWI Prolog.  It makes things faster than "drap.pl",
%% BUT CYCLIC TERMS ARE NOT HANDLED PROPERLY (i.e., don't use for coinduction).
%% See dra_common.pl for documentation.
